...
import techLOGO from './technology-image.png';
        ...
        <>
            { loading ? (
                <div className="flex-col gap-4 w-full flex items-center justify-center" >
                    ...
                    <>
                        <div className='my-2'>
                            <Link href='/' className="bg-white text-center w-48 rounded-2xl h-14 relative text-black text-xl font-semibold group" type="button">
