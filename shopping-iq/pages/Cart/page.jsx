  ...
  return (
    <>
      <div className="p-10 min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <button onClick={() => router.push('/Products')} className="bg-white text-center w-48 rounded-2xl h-14 ml-5 relative text-black text-xl font-semibold group mb-5" type="button">
        ...
        {loading ? (
          ...
          <>
            <div className="max-w-4xl mx-auto space-y-6">
              {cartItems.map((item) => (
                <div key={item.productId} className="bg-white hover:border-none hover:scale-105 hover:shadow-indigo-600  dark:bg-gray-800 rounded-lg shadow-md p-4 flex items-center border-l-4 border-blue-600">
                  <img
                    src={item.image}
                    alt={item.title}
              ...
              <div className="pt-4">
                <p className="text-lg font-bold text-red-700 flex gap-1">
              ...
              {!userData ? (
                <>
                  ...
                  <button onClick={() => router.push('/Login')} className="cursor-pointer bg-gradient-to-b from-blue-500 to-blue-600 px-6 py-3 rounded-xl border-[1px] border-none text-white font-medium group">
                ...
                <>
                  <button onClick={() => router.push('/Payment')} className="overflow-hidden relative w-32 p-2 h-12 bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-10 group">
                    Buy now
