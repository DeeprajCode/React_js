            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="pt-4">
                <p className="text-lg font-medium text-red-700 dark:text-red-800 flex gap-1">
                  Price: <span className='flex gap-1 line-through'> <TbCurrencyDollar className='mt-1.5' /> {total.toFixed(2)} </span>
                </p>
                <p className="flex text-lg font-medium text-yellow-700 flex gap-1">
