        ...
        {loading ? (
          ...
          <>
            ...
            <div className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <div className="pt-3 pb-6 text-base max-w-2xl text-center m-auto dark:text-gray-400">
                Your happiness is our success.
                <p>We're here to help you every step of the way, our service sets us apart from the rest.</p>
              </div>
            </div>
